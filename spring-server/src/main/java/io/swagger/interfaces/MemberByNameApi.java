...
@Api(value = "memberByName", description = "the memberByName API")
@RequestMapping()
public interface MemberByNameApi {
    ...
    @RequestMapping(value = "/memberByName/{name}",
        produces = {"application/json" },
        method = RequestMethod.GET)
    ResponseEntity<List<Member>> getMemberByName(@ApiParam(value = "name of member to return",required=true) @PathVariable("name") String name);
